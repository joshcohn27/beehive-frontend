...
import { HiveDataContent, AllHiveDataResponse } from "../types/JSONTypes";
...
const GraphPage = () => {
  ...
  const [startData, setStartDate] = useState<Date>(() => {
    ...
    fetchJson<AllHiveDataResponse>("/HiveData", {
      ...
      .then((data) => {
        ...
        const fetchedData: AllHiveDataResponse = {
          ...
          Hive_Data: [...allHiveData.Hive_Data]
            .map((entry: HiveDataContent) => ({
              TimeStamp: entry.TimeStamp,
